...
upload:
	...
	aws --profile $(AWS_PROFILE) s3 cp workflows s3://relevance-development-ap-southeast-2-workflows/$(ENVIRONMENT)/ --recursive
	aws --profile $(AWS_PROFILE) s3 cp workflows s3://relevance-development-us-east-1-workflows/$(ENVIRONMENT)/ --recursive
