...
WORKFLOWS = [
    {
        ...
        "documentation_links": [
            {
                "title": "SDK Reference",
                "url": "https://relevanceai.readthedocs.io/en/development/relevanceai.bias_detection.html",
            }
        ],
        "video_links": [],
        "new": True,
    ...
    },
    {
        ...
        "type": "recipe",
        "colab_link": COLAB_PREFIX
        + "workflows/twitter-analysis/AI_Twitter_Analysis_by_Relevance_AI.ipynb",
